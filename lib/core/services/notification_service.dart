...
//     final body = msg.notification?.body ?? data['body'] ?? "No Body"; // ✅ FIX: Renamed from 'description' to 'body'
...
//       id: id,
//       title: title,
//       body: body, // ✅ FIX: Added required 'body'
//       type: type, // ✅ FIX: Added required 'type'
//       senderId: senderId, // ✅ FIX: Added required 'senderId'
//       receiverId: receiverId, // ✅ FIX: Added required 'receiverId'
//       targetId: targetId, // ✅ FIX: Added required 'targetId'
//       data: data, // ✅ FIX: Added required 'data'
//       time: DateTime.now(),
//       isRead: false,
